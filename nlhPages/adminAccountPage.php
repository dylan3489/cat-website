...
<body>
    ...
    <section class="account-details-section">
        <div class="account-box-left">
            ...
            <a href="adminEditAccountPage.php" class="edit-details-btn">Edit Details</a>
        </div>

        <div class="account-box-right">
            <h2>Quick Links</h2>
            <ul>
                <li><a href="adminDonationsDatabasePage.php">Donations Database</a></li>
                <li><a href="adminsSponsorshipDatabasePage.php">Sponsorships Database</a></li>
                <li><a href="adminStoriesDatabasePage.php">Success Stories Database</a></li>
